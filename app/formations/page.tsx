...
export default function FormationsPage() {
  const formations = [
    ...
    },
    {
      ...
      hours: "24–60 h",
      description: ["Process & tools", "Gestion aléas", "CBTA & reporting"],
  ...
  return (
    <main className="relative z-10 px-6 py-24 md:py-32 max-w-7xl mx-auto text-white">
      {/* ---- Titre ---- */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
        {formations.map((f) => (
          <div
            key={f.title}
            className="card-pfotc p-6 rounded-2xl bg-white/5 backdrop-blur-md 
            border border-white/10 hover:ring-1 hover:ring-cyan-400 transition 
